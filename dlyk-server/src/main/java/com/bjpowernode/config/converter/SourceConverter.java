...
public class SourceConverter implements Converter<Integer> {
    ...
    public Integer convertToJavaData(ReadCellData<?> cellData, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        ...
        if (StringUtils.hasText(data)) { //excel单元格读到了线索来源的中文，比如是“汽车之家”
            //把“汽车之家”转换为14
            List<TDicValue> tDicValueList = (List<TDicValue>) BaseApplication.cacheMap.get(DicEnum.SOURCE.getDicName());
